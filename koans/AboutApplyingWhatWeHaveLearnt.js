...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    var sum = _.range(1, 1000).reduce(function(memo, x) { if (x % 3 === 0 || x % 5 === 0 ) { return memo + x; } else { return memo + 0; } }, 0);    /* try chaining range() and reduce() */
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientsCount = _(products).chain()
    	.map(function(food) { return food.ingredients })
    	.flatten()
	    .reduce(function(memo, ingredient){ if(ingredient === "mushrooms") { return memo + 1; } else { return memo; }  }, 0);
